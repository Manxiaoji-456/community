            ...
            <div class="layui-tab-content" >
                <div class="layui-tab-item layui-show">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="uasername" autocomplete="off" placeholder="空制在80个汉字，160个字符以内"
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="complaint_name" autocomplete="off" placeholder="空制在80个汉字，160个字符以内"
...
<script>
    layui.use(['laydate','element','layer','form'], function(){
        ...
        form.on('submit(add)', function(data){
            ...
            var complaint_name=$("input[name='complaint_name']").val();
            ...
            if(complaint_name==""){
                layer.msg('投诉名称不能为空',{icon:5,time:2000});return false;
            }
            var data=data.field;
            $.ajax({
                type:"post",
