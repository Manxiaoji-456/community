...
<div class="x-body">
    ...
    <xblock>
        ...
        <button class="layui-btn" onclick="device_add('活动添加','device_add.html','1000','600')">
    ...
    <table class="layui-table">
        ...
        <tr>
            ...
            <td class="td-manage">
                <a title="编辑" href="javascript:;" onclick="device_edit('编辑','device_add.html','1','1000','600')"
                   class="ml-5" style="text-decoration:none">
                    <i class="layui-icon">&#xe642;</i>
                </a>
                <a title="删除" href="javascript:;" onclick="device_del(this,'1')"
                   style="text-decoration:none">
                    <i class="layui-icon">&#xe640;</i>
                </a>
            </td>
