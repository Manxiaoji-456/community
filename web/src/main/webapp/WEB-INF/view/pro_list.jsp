...
<div class="x-body">
    ...
    <xblock>
        ...
        <button class="layui-btn" onclick="pro_add('活动添加','pro_add.html','1000','600')">
    ...
    <table class="layui-table">
        ...
        <tr>
            ...
            <td >
                2020-01-05 20:07:35                        </td>
            <td class="td-manage">
                <a title="编辑" href="javascript:;" onclick="pro_edit('编辑','pro_add.html','3','1000','600')"
        ...
        <tr>
            ...
            <td >
                2020-01-05 20:06:45                        </td>
            <td class="td-manage">
                <a title="编辑" href="javascript:;" onclick="pro_edit('编辑','pro_add.html','1','1000','600')"
                   class="ml-5" style="text-decoration:none">
                    <i class="layui-icon">&#xe642;</i>
                </a>
                <a title="删除" href="javascript:;" onclick="pro_del(this,'1')"
                   style="text-decoration:none">
                    <i class="layui-icon">&#xe640;</i>
                </a>
            </td>
