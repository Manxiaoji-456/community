...
<div class="x-body">
    ...
    <table class="layui-table">
        ...
        <tr>
            ...
            <td class="td-status"> <span class="layui-btn layui-btn-danger " > 已受理 </span> </td>
            <td class="td-manage">
        ...
        <tr>
            ...
            <td class="td-status"> <span class="layui-btn layui-btn-normal " > 待受理 </span>
            </td>
            <td class="td-manage">
                <a title="编辑" href="javascript:;" onclick="repair_edit('编辑','repairadd.html','1','1000','600')"
                   class="ml-5" style="text-decoration:none">
                    <i class="layui-icon">&#xe642;</i>
                </a>
                <a title="删除" href="javascript:;" onclick="repair_del(this,'1')"
                   style="text-decoration:none">
                    <i class="layui-icon">&#xe640;</i>
                </a>
            </td>
